...
{{- printf "postgres://%s:%s@%s/%s" .Values.postgresql.envVars.postgresUser .Values.postgresql.envVars.postgresPassword (include "postgresql.fullname" .) .Values.postgresql.envVars.postgresDb -}}
{{- end -}}
