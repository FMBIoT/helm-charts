...
{{/*
Name of the component authzclient.
*/}}
{{- define "authzclient.name" -}}
{{- printf "%s-authzclient" (include "enabler.name" .) | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Create a default fully qualified component authzclient name.
We truncate at 63 chars because some Kubernetes name fields are limited to this (by the DNS naming spec).
If release name contains chart name it will be used as a full name.
*/}}
{{- define "authzclient.fullname" -}}
{{- printf "%s-authzclient" (include "enabler.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}